...
*/
const { isDevLink } = require("../lib/example_helper");
...
module.exports = async function (helper) {
  ...
  if (!answer1 || !isDevLink(answer1)) {
    return helper.fail(`
      After you have googled discord dev portal it should be the first link that pops up
    `);
  }
